...
@section('content')
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">CMS Pages</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage static pages like Documentation, FAQ, Legal, etc.</p>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $page->title }}
                                        </div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">/p/{{ $page->slug }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                ...
                                <span class="block text-sm font-medium">No pages created yet.</span>
                            </td>
                        </tr>
                    @endforelse
                </tbody>

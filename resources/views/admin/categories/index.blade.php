...
@section('content')
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage software categories used to organize products in
                the marketplace.</p>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div
                                        class="h-10 w-10 flex-shrink-0 rounded-md bg-indigo-50 dark:bg-gray-700 flex items-center justify-center text-indigo-500 dark:text-gray-400 border border-indigo-100 dark:border-gray-600">
                                        @if($category->icon)
                                            {!! $category->icon !!}
                                        @else
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-400">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end gap-3">
                                    ...
                                    <form action="{{ route('admin.categories.destroy', $category->id) }}" method="POST"
                                        onsubmit="return confirm('Are you sure you want to delete this category? Products might be affected.');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                ...
                                <span class="block text-sm font-medium">No categories created yet.</span>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
